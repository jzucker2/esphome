...
void TotoIR::send_power_toggle(bool set_timer) {
...
void TotoIR::send_rear_wash(bool set_timer) {
...
void TotoIR::send_feminine_wash(bool set_timer) {
...
void TotoIR::send_oscillating_cleansing(bool set_timer) {
...
void TotoIR::send_pulsating_cleansing(bool set_timer) {
...
void TotoIR::set_water_pressure(const std::string &state, bool set_timer) {
...
void TotoIR::set_water_position(const std::string &state, bool set_timer) {
...
void TotoIR::set_water_temperature(const std::string &state, bool set_timer) {
...
void TotoIR::set_seat_temperature(const std::string &state, bool set_timer) {
...
void TotoIR::set_fan_temperature(const std::string &state, bool set_timer) {
...
void TotoIR::set_configuration(const TotoConfig &config, bool set_timer) {
...
void TotoIR::reset_configuration(bool set_timer) {
